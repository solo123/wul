...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { amount: @coupon.amount, desc: @coupon.desc, title: @coupon.title, user_id: @coupon.user_id }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { amount: @coupon.amount, desc: @coupon.desc, title: @coupon.title, user_id: @coupon.user_id }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
